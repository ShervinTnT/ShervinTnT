...
```ts
const shervin = {
  code:      ["TypeScript", "Rust", "JavaScript", "Node.js"],
  building:  ["real-time apps", "WebRTC mesh calls", "Tauri desktop & mobile"],
  tools:     ["Express", "WebSockets", "Vite", "Cargo"],
  vibe:      "ship fast, keep it lightweight, make it pretty",
};
```
